                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    ...
                    <div className="p-8">
                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <div className="mt-2 flex justify-end">
                                    <Link to="/forgot-password" className="text-sm text-purple-600 hover:text-purple-800 transition duration-200">
                                        Forgot password?
                                    </Link>
                                </div>
                            </div>
                            ...
                            <motion.button
                                ...
                                disabled={loading}
                            >
                                {loading ? <span>Signing In...</span> : (<><span>Sign In</span><FaArrowRight className="text-sm" /></>)}
                            </motion.button>
                        </motion.form>
                        ...
                        >
                            ...
                            <Link to="/signup" className="text-purple-600 font-medium hover:text-purple-800 transition duration-200">
                                Sign up
                            </Link>
                        </motion.div>
                    </div>
